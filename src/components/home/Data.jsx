...
const Data = () => {
  return (
    <div className="home__data">
        ...
        <h3 className="home__subtitle">Developer | Programmer</h3>
        <p className="home__description">
                    A Software Engineer and Developer with an understanding of
            algorithms and Dev languages. Passionate about implementing and launching new
            projects and expanding my knowledge in the field of computer
            science.
        </p>
        <a href="#contact" className="button button--flex">
            Say Hello
            <img src={star} alt="" className="star first" />
            <img src={wink} alt="" className="star alt" />
            {/* <svg
                  class="button__icon"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
